...
namespace SitecoreExtensions.Modules.FavouriteItems {
    ...
    import StorageType = SitecoreExtensions.Modules.Launcher.StorageType;
    export class FavouriteItemsStore {
        array: Array<string>;
        recentCommandsKey: string = "sc_ext::favourite_items";
        ...
        add(command: IFavouriteItem): void {
        ...
        remove(activeNodeID:any): void {

            let indexToRemove = this.array.indexOf(activeNodeID);
            if (indexToRemove > -1) {
        ...
        async getRecentCommands(commands: IFavouriteItem[]) {
            ...
            let result = new Array<IFavouriteItem>();
